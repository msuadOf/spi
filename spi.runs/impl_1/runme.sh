...
HD_PWD='/home/zz/xilinx/spi/spi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_tb.tcl -notrace
